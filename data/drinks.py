...
drink_description = dict(
    ginandtonic='A gin and tonic is a highball cocktail made with gin and tonic water poured over ice. /n The cocktail was introduced by the army of the British East India Company in India. In India and other tropical regions, malaria was a persistent problem. In the 1700s it was discovered that quinine could be used to prevent and treat the disease, although the bitter taste was unpleasant. British officers in India in the early 19th century took to adding a mixture of water, sugar, lime and gin to the quinine in order to make the drink more palatable.[17] Soldiers in India were already given a gin ration, and the sweet concoction made sense.[18] Since it is no longer used as an antimalarial, tonic water today contains much less quinine, is usually sweetened, and is consequently much less bitter.',
...
drink_recipie = dict(
    ginandtonic=[[1, 'Gin'], [3, 'Tonic Water']]
)
